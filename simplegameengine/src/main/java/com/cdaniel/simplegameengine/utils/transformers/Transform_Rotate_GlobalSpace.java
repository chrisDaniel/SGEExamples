 ...
 */
public class Transform_Rotate_GlobalSpace implements TransformGlobalSpace {
    ...
    Transform_Rotate_GlobalSpace(float rotationAboutY){
    ...
    *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    ...
    public static class Transform_RotateBuilder {
        ...
        public Transform_Rotate_GlobalSpace.Transform_RotateBuilder rotationAboutY(float rotationAboutY) {
            this.rotationAboutY = rotationAboutY;
            return this;
        }

        public Transform_Rotate_GlobalSpace build() {
            return new Transform_Rotate_GlobalSpace(rotationAboutY);
        }
    }
}
